...
bg = pygame.image.load(r'images/main-clock.png').convert()
bg_rect = bg.get_rect()
image_left = pygame.image.load(r"images/left-hand.png")
left_rect = image_left.get_rect(bottomleft = (415,560))
image_right = pygame.image.load(r"images/right-hand.png")
