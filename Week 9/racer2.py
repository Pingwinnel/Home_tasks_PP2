...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(pygame.image.load("images/Coin.png").convert_alpha(), (75, 100))
...
class SpecialCoin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        # Take image from /media/ folder and scale it 75x100
        self.image = pygame.transform.scale(pygame.image.load("images/coin2.png").convert_alpha(), (75, 100))
        # Creating HitBoxes of this image
        self.rect = self.image.get_rect()
...
class Enemy(pygame.sprite.Sprite):
      def __init__(self):
        ...
        self.image = pygame.transform.rotate(pygame.transform.scale(pygame.image.load("images/Enemy.png"), (100, 200)), 180)
        self.rect = self.image.get_rect()
        self.rect.center=(random.randint(30, w-30),0) 
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.transform.scale(pygame.image.load("images/Player.png"), (100, 200))
        self.rect = self.image.get_rect()
